...
getter = ipgetter2.IPGetter()
ipv4 = getter.get().v4
print(ipv4)

# Todo
# Create Cog_Template with help, list of commands
# For each cog, generate */cog_template route
# link cog name to */cog route
# Create Command_template with help
# For each command, generate */cog/command_template route
# Link each command to */cog/command route
# For each Server
# If server allows Invites:
# Link server invite to server name
